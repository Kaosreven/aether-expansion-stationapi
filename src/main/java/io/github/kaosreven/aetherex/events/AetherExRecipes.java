    ...
    public void registerRecipes(RecipeRegisterEvent event) {
        ...
        if (Objects.requireNonNull(type) == RecipeRegisterEvent.Vanilla.CRAFTING_SHAPED) {
            ...
            if (FabricLoader.getInstance().isModLoaded("stonewall")) {
                ...
                //CraftingRegistry.addShapedRecipe(new ItemStack(AetherExBlocks.CarvedLitWall, 6), "###", "###", '#', new ItemStack(AetherBlocks.LightDungeonStone, 1, 0));
                CraftingRegistry.addShapedRecipe(new ItemStack(AetherExBlocks.AngelicWall, 6), "###", "###", '#', new ItemStack(AetherBlocks.DungeonStone, 1, 1));
                //CraftingRegistry.addShapedRecipe(new ItemStack(AetherExBlocks.AngelicLitWall, 6), "###", "###", '#', new ItemStack(AetherBlocks.LightDungeonStone, 1, 1));
                CraftingRegistry.addShapedRecipe(new ItemStack(AetherExBlocks.HellfireWall, 6), "###", "###", '#', new ItemStack(AetherBlocks.DungeonStone, 1, 2));
                //CraftingRegistry.addShapedRecipe(new ItemStack(AetherExBlocks.HellfireLitWall, 6), "###", "###", '#', new ItemStack(AetherBlocks.LightDungeonStone, 1, 2));
            }
        }
