...
public class RenderUnholySwordDart extends EntityRenderer {
    public RenderUnholySwordDart() {
    }
    ...
    public void renderDartGolden(EntityDartGolden entitygolden, double d, double d1, double d2, float f, float f1) {
        if (entitygolden.victim == null) {
            this.bindTexture("aetherex:stationapi/textures/other/UnholySwordDart.png");
            GL11.glPushMatrix();
