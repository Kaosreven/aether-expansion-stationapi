package io.github.kaosreven.aetherex.client.entity.renderer.projectile;
...
public class RenderUnholyArrow extends EntityRenderer {
    public RenderUnholyArrow() {
    }

    public void func_154_a(EntityLightningUnholyArrow entityarrow, double d, double d1, double d2, float f, float f1) {
        if (entityarrow.prevYaw != 0.0F || entityarrow.prevPitch != 0.0F) {
            this.bindTexture("aetherex:stationapi/textures/other/UnholyArrow.png");
            GL11.glPushMatrix();
    ...
    public void render(Entity entity, double d, double d1, double d2, float f, float f1) {
        this.func_154_a((EntityLightningUnholyArrow) entity, d, d1, d2, f, f1);
    }
}
